                                    ...
                                    <div class="row">
                                        <div class=" col-md-6">
                                            <div class="form-group category">
                                                ...
                                                <select name="project" id="project" onchange="get_ajax_buildings(this.value), get_ajax_project_user(this.value)"  class="form-control">
                                                    <option value="">Select</option>
                                                    @if($projects)
                                    ...
                                    <div class="row">
                                        <div class=" col-md-6">
                                            <div class="form-group category">
                                                ...
                                                <select name="site_visit_done"  class="form-control">
                                        ...
                                        <div class=" col-md-6">
                                            <div class="form-group category">
                                                <label for="exampleInputEmail1">Booking Done</label>
                                                <select name="booking_done"  class="form-control">
                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class=" col-md-6">
                                            <div class="form-group cuisine">
                                                <label for="exampleInputEmail1">Priority (Status)</label>
